name := "angularjs-twitter-search"

description := "This project uses Scalatra, AngularJS, and other great tools to implement the AngularJS Twitter Search example"

homepage := Some(url("https://github.com/dkrieg/scalatra-angularjs-examples/angularjs-twitter-search"))

startYear := Some(2013)

scmInfo := Some(
  ScmInfo(
    url("https://github.com/dkrieg/scalatra-angularjs-examples"),
    "scm:git:https://github.com/dkrieg/scalatra-angularjs-examples",
    Some("scm:git:git@github.com:dkrieg/scalatra-angularjs-examples.git")
  )
)
